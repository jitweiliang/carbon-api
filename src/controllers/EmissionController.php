        ...
        public function processRequest(string $verb, ?string $uri): void 
        {
            switch ($verb) {
                    ...
                    switch(true) {
                        ...
                        case preg_match('/\/api\/emissions\/id\/[1-9]/', $uri):
                            ...
                            $stmt = "select t1.id as id, t1.user_id as userId, t2.user_name as userName,
                                        ...
                                        t1.food as food, t1.total_emission as totalEmission, t1.submittedDate as submittedDate
                ...
                case "POST":
                    ...
                    $sql->bindValue(":household",      $model["title"],   PDO::PARAM_INT);
                    $sql->bindValue(":transportation", $model["message"], PDO::PARAM_INT);
                    $sql->bindValue(":food",           $model["imgUrl"],  PDO::PARAM_INT);
